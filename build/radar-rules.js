({ "81.cn":{ _name:"中国军网",
  ...
  "naver.com":{ _name:"네이버",
    comic:[ { title:"Series",
        ...
        source:[ "/webtoon/list",
          "/webtoon/detail",
          "/webtoon/info" ],
        target:"/naver/webtoon/series/:titleId" } ],
    "m.search":[ { title:"검색",
        docs:"https://docs.rsshub.app/routes/other",
        source:[ "/search.naver" ],
    ...
    blog:[ { title:"Blog Posts",
        ...
        source:[ "/:blogId",
          "/:blogId/*" ],
        target:"/spec/spec/naver/blog/:blogId" } ],
    "m.comic":[ { title:"Webtoon Episodes",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/webtoon/list?titleId=:titleId",
          "/webtoon/list?titleId=:titleId" ],
        target:"/spec/spec/naver/webtoon/:titleId" } ] },
  ...
  "netflix.com":{ _name:"Netflix",
    ...
    www:[ { title:"Title Episodes",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/title/:netflixTitleId" ],
        target:"/spec/spec/netflix/:netflixTitleId" },
      { title:"Title Episodes",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/watch/:netflixTitleId" ],
        target:"/spec/spec/netflix/:netflixTitleId" } ] },
  ...
  "bubble.us":{ _name:"SPEC",
    ".":[ { title:"Artist Room Messages",
        docs:"https://docs.rsshub.app/routes/social-media",
        source:[ "/channel/:artistId" ],
        target:"/spec/spec/bubble/:artistId" } ] },
  "viki.com":{ _name:"SPEC",
    www:[ { title:"Series Episodes",
        docs:"https://docs.rsshub.app/routes/multimedia",
        source:[ "/tv/:titleId" ],
        target:"/spec/spec/viki/:titleId" } ] },
  "weverse.io":{ _name:"SPEC",
    ".":[ { title:"Artist Community Feed",
        docs:"https://docs.rsshub.app/routes/social-media",
        source:[ "/:artistSlug",
          "/:artistSlug/feed" ],
        target:"/spec/spec/weverse/:artistId" } ] },
  "youtube.com":{ _name:"SPEC",
    www:[ { title:"Channel (videos, shorts, live, posts)",
        docs:"https://docs.rsshub.app/routes/multimedia",
