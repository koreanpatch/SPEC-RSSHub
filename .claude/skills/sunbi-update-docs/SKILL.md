...
Follow the procedure in `.claude/skills/_common/pragmatist-review.md`. Focus on cross-doc consistency, voice consistency, and missing cross-references across the `.planning/` documentation set.
...
- After all docs are updated and verified, auto-commit following `.claude/skills/_common/auto-commit.md`. If pre-commit hooks modify files, re-stage and retry once.
</rules>
