...
Follow the procedure in `.claude/skills/sunbi/_common/worktree-guard.md` with `$SKILL_NAME=research`.
...
- After SUMMARY.md is written, auto-commit all research output following `.claude/skills/sunbi/_common/auto-commit.md`. If pre-commit hooks modify files, re-stage and retry once.
</rules>
